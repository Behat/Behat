<?php return array(
    ...
    'pl' => array(
        'snippet_proposal_title' => '<snippet_undefined><snippet_keyword>%1%</snippet_keyword> posiada brakujące kroki. Zdefiniuj je przy użyciu następujących snippetów:</snippet_undefined>',
        'snippet_missing_title'  => '<snippet_undefined>Snippety dla następujących kroków w <snippet_keyword>%1%</snippet_keyword> nie zostały wygenerowane (sprawdź konfigurację):</snippet_undefined>',
        'failed_scenarios_title' => 'Błędne scenariusze:',
        'failed_hooks_title'     => 'Błędne hooki:',
        'failed_steps_title'     => 'Błędne kroki:',
        'pending_steps_title'    => 'Oczekujące kroki:',
        'scenarios_count'        => '{0} Brak scenariuszy|{1} 1 scenariusz|]1,Inf] %1% scenariuszy',
        'steps_count'            => '{0} Brak kroków|{1} 1 krok|]1,Inf] %1% kroki',
        'passed_count'           => '[1,Inf] %1% zakończonych sukcesem',
        'failed_count'           => '[1,Inf] %1% błędnych',
        'pending_count'          => '[1,Inf] %1% oczekujących',
        'undefined_count'        => '[1,Inf] %1% niezdefiniowanych',
        'skipped_count'          => '[1,Inf] %1% opuszczonych',
    ),
);

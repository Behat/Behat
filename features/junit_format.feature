Feature: JUnit Formatter
  ...
  Scenario: Multiple parameters
    ...
    And the junit file "/tmp/test/behat/TEST-World.xml" should contain:
      ...
      <testsuite classname="behat.features" errors="0" failures="0" name="World consistency" file="/tmp/behat/XXX/features/World.feature" tests="2" assertions="8" time="XXX">
  ...
  Scenario: Multiple parameters
    ...
    And the junit file "/tmp/test/behat/TEST-World-Error.xml" should contain:
      """
      <?xml version="1.0" encoding="UTF-8"?>
      <testsuite classname="behat.features" errors="0" failures="1" name="World consistency" file="/tmp/behat/XXX/features/World-Error.feature" tests="2" assertions="7" time="XXX">

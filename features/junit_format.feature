    ...
    And "junit/default.xml" file xml should be like:
      ...
      <testsuites name="default">
        <testsuite name="World consistency" tests="8" skipped="0" failures="3" errors="2" time="-IGNORE-VALUE-">
          <testcase name="Undefined" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="undefined" time="-IGNORE-VALUE-">
            <error message="And Something new" type="undefined"/>
          </testcase>
          <testcase name="Pending" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="pending" time="-IGNORE-VALUE-">
            <error message="And Something not done yet: TODO: write pending definition" type="pending"/>
          </testcase>
          <testcase name="Failed" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="failed" time="-IGNORE-VALUE-">
            <failure message="Then I must have 13: Failed asserting that 14 matches expected '13'."/>
          </testcase>
          <testcase name="Passed &amp; Failed #1" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="failed" time="-IGNORE-VALUE-">
            <failure message="Then I must have 16: Failed asserting that 15 matches expected '16'."/>
          </testcase>
          <testcase name="Passed &amp; Failed #2" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="passed" time="-IGNORE-VALUE-"/>
          <testcase name="Passed &amp; Failed #3" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="failed" time="-IGNORE-VALUE-">
            <failure message="Then I must have 32: Failed asserting that 33 matches expected '32'."/>
          </testcase>
          <testcase name="Another Outline #1" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="passed" time="-IGNORE-VALUE-"/>
          <testcase name="Another Outline #2" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="passed" time="-IGNORE-VALUE-"/>
        </testsuite>
      </testsuites>
      """
    ...
    And "junit/default.xml" file xml should be like:
      ...
      <testsuites name="default">
        <testsuite name="Adding Feature 1" tests="1" skipped="0" failures="0" errors="0" time="-IGNORE-VALUE-">
          <testcase name="Adding 4 to 10" classname="Adding Feature 1" file="features-DIRECTORY-SEPARATOR-adding_feature_1.feature" status="passed" time="-IGNORE-VALUE-"></testcase>
        </testsuite>
        <testsuite name="Adding Feature 2" tests="1" skipped="0" failures="0" errors="0" time="-IGNORE-VALUE-">
          <testcase name="Adding 8 to 10" classname="Adding Feature 2" file="features-DIRECTORY-SEPARATOR-adding_feature_2.feature" status="passed" time="-IGNORE-VALUE-"></testcase>
        </testsuite>
      </testsuites>
      """
    And the file "junit/default.xml" should be a valid document according to "junit.xsd"
    ...
    And "junit/default.xml" file xml should be like:
      ...
      <testsuites name="default">
        <testsuite name="World consistency" tests="2" skipped="0" failures="0" errors="0" time="-IGNORE-VALUE-">
          <testcase name="Adding some interesting value" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="passed" time="-IGNORE-VALUE-"/>
          <testcase name="Subtracting some value" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="passed" time="-IGNORE-VALUE-"/>
        </testsuite>
      </testsuites>
      """
    And the file "junit/default.xml" should be a valid document according to "junit.xsd"
    ...
    And "junit/small_kid.xml" file xml should be like:
      ...
      <testsuites name="small_kid">
        <testsuite name="Apple Eating" tests="1" skipped="0" failures="0" errors="0" time="-IGNORE-VALUE-">
          <testcase name="Eating one apple" classname="Apple Eating" file="features-DIRECTORY-SEPARATOR-apple_eating_smallkid.feature" status="passed" time="-IGNORE-VALUE-"/>
        </testsuite>
      </testsuites>
      """
    ...
    And "junit/old_man.xml" file xml should be like:
      ...
      <testsuites name="old_man">
        <testsuite name="Apple Eating" tests="1" skipped="0" failures="1" errors="0" time="-IGNORE-VALUE-">
          <testcase name="Eating one apple" classname="Apple Eating" file="features-DIRECTORY-SEPARATOR-apple_eating_oldmen.feature" status="failed" time="-IGNORE-VALUE-">
    ...
    And "junit/default.xml" file xml should be like:
      ...
      <testsuites name="default">
        <testsuite name="World consistency" tests="2" skipped="2" failures="0" errors="0" time="-IGNORE-VALUE-">
          <testcase name="Skipped" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="skipped" time="-IGNORE-VALUE-"/>
          <testcase name="Another skipped" classname="World consistency" file="features-DIRECTORY-SEPARATOR-World.feature" status="skipped" time="-IGNORE-VALUE-"/>
        </testsuite>
      </testsuites>
      """
    And the file "junit/default.xml" should be a valid document according to "junit.xsd"

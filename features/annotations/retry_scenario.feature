Feature: Multiple tries
  ...
  Scenario: Pass/Fail after multiple retry attempts
  ...
  Scenario: Pass/Fail after multiple background attempts
    Given a file named "features/bootstrap/FeatureContext.php" with:
      """
      <?php
  ...
  Scenario: Pass/fail after multiple outline attempts
    Given a file named "features/bootstrap/FeatureContext.php" with:
      """
      <?php

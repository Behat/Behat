Feature: Context consistency
  ...
  Then it should fail with:
    ...
    behat [--init] [--story-syntax] [-d|--definitions="..."] [--name="..."] [--tags="..."] [--role="..."] [-f|--format="..."] [--out="..."] [--lang="..."] [--ansi] [--no-ansi] [--no-time] [--no-paths] [--no-snippets] [--no-multiline] [--expand] [--snippets-paths] [--append-snippets] [--stop-on-failure] [--dry-run] [--rerun] [--strict] [--suite="..."] [features]
    """

Feature: To do
  ...
  Scenario: Run custom profile without extensions
    Given a file named "features/extensions.feature" with:
      """
      Feature:
        Scenario:
          When this scenario executes
          Then the extension "custom extension 1" should be loaded
          And the extension "custom extension 2" should not be loaded
      """
